...
interface MItemEvent: MEvent {
    ...
    data class RightClickEntity(override var isCancelled: Boolean, override val player: Player, override val itemStack: ItemStack, val target: Entity): MItemEvent, MCancellable
    ...
    data class AttackLivingEntity(override var isCancelled: Boolean, override val player: Player, override val itemStack: ItemStack, val target: LivingEntity, var damage: Double): MItemEvent, MCancellable
}